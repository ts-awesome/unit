...
describe('compile mul expression', () => {
  ...
  it('mul', async () => {
    ...
    expect(test.definition).toStrictEqual({'ephimeral': 2});
  ...
  it('mul other', async () => {
    ...
    expect(test.definition).toStrictEqual({'ephimeral': 1, 'time': 1});
    expect(test.to(1)).toBe(10);
    expect(test.from(10)).toBe(1);
  });
...
describe('compile div expression', () => {
  ...
  it('div', async () => {
    ...
    expect(test.definition).toStrictEqual({});
    expect(test.to(1)).toBe(10);
    expect(test.from(10)).toBe(1);
  });
...
describe('compile pow expression', () => {
  ...
  it('pow 3', async () => {
    ...
    expect(test.definition).toStrictEqual({'ephimeral': 3});
