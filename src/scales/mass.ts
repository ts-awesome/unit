...
/** 
 * @summary 1 u = 1.66053904e-27 kg
 * @description <b>Atomic mass unit, unified</b> is  <i>mass</i> unit, symbol: [u; AMU]. Definition of 1 atomic mass unit, unified ≡ 1.66053904e-27 kg. The unified atomic mass unit or dalton is a standard unit of mass that quantifies mass on an atomic or molecular scale (atomic mass)..
...
export const AtomicMassUnitUnified__AMU = scale("Atomic mass unit, unified", "AMU", mul(unit(1, kilogram), 1.66053904e-27));

/** 
 * @summary 1 me = 9.10938356e-31 kg
 * @description <b>Atomic unit of mass, electron rest mass</b> is  <i>mass</i> unit, symbol: [me]. Definition of 1 atomic unit of mass, electron rest mass ≡ 9.10938356e-31 kg. .
 ...
 * @description <b>Bag (coffee)</b> is  <i>mass</i> unit. Definition of 1 bag (coffee) ≡ 60 kg . .
 ...
 * @description <b>Centigram</b> is metric <i>mass</i> unit, symbol: [cg]. Definition of 1 Centigram  ≡1e-5 kg. .
 * @link http://conversion.org/mass/centigram/
 */
export const Centigram = scale("Centigram", "cg", mul(unit(1, kilogram), 0.00001));

/** 
 * @summary 1 Da = 1.66053904e-27 kg
 * @description <b>Dalton</b> is  <i>mass</i> unit, symbol: [Da]. Definition of 1 dalton ≡ 1.66053904e-27 kg. Dalton (Da) or the unified atomic mass unit is a standard unit of mass that quantifies mass on an atomic or molecular scale (atomic mass)..
 ...
 * @description <b>Decagram</b> is metric <i>mass</i> unit, symbol: [dag]. Definition of 1 Decagram  ≡1e-2 kg. .
...
/** 
 * @summary 1 g = 1e-3 kg
 * @description <b>Gram</b> is metric <i>mass</i> unit, symbol: [g]. Definition of 1 Gram  ≡1e-3 kg. .
 ...
 * @description <b>Hectogram</b> is metric <i>mass</i> unit, symbol: [hg]. Definition of 1 Hectogram  ≡1e-1 kg. .
 ...
 * @description <b>Microgram</b> is metric <i>mass</i> unit, symbol: [µg]. Definition of 1 Microgram  ≡1e-9 kg. .
 ...
 * @description <b>Milligram</b> is metric <i>mass</i> unit, symbol: [mg]. Definition of 1 Milligram  ≡1e-6 kg. .
 ...
 * @description <b>Mite (metric)</b> is  <i>mass</i> unit. Definition of 1 mite (metric) ≡  1⁄20 g . ≡ 50 mg.
 ...
 * @description <b>Nanogram</b> is metric <i>mass</i> unit, symbol: [ng]. Definition of 1 Nanogram  ≡1e-12 kg. .
 * @link http://conversion.org/mass/nanogram/
 */
export const Nanogram = scale("Nanogram", "ng", mul(unit(1, kilogram), 1e-12));

/** 
 * @summary 1 oz (US) = 28 g
 * @description <b>Ounce (US food nutrition labelling)</b> is  <i>mass</i> unit, symbol: [oz (US)]. Definition of 1 ounce (US food nutrition labelling) ≡ 28 g. The ounce (abbreviated oz) is a unit of mass used in most British derived customary systems of measurement..
 ...
 * @description <b>Pound (avoirdupois)</b> is  <i>mass</i> unit, symbol: [lb av]. Definition of 1 pound (avoirdupois) ≡ 0.45359237 kg ≡ 7000 grains . By definition, 1 lb av ≡ exactly 0.45359237 kg.
 ...
 * @description <b>Pound (metric)</b> is  <i>mass</i> unit. Definition of 1 pound (metric) ≡ 500 g . ≡ 500 g ≡ 0.5 kg.
 * @link http://conversion.org/mass/pound-metric/
 */
export const PoundMetric = scale("Pound (metric)", "pound (metric)", mul(unit(1, Gram), 500));

/** 
 * @summary 1 quarter (imp) = 1⁄4 long cwt = 2 st = 28 lb av
 * @description <b>Quarter (imperial)</b> is  <i>mass</i> unit. Definition of 1 quarter (imperial) ≡  1⁄4 long cwt ≡ 2 st ≡ 28 lb av . 28 × 0.45359237 kg.
...
/** 
 * @summary 1 q = 100 kg
 * @description <b>Quintal (metric)</b> is  <i>mass</i> unit, symbol: [q]. Definition of 1 quintal (metric) ≡ 100 kg . .
 ...
 * @description <b>Sheet</b> is  <i>mass</i> unit. Definition of 1 sheet ≡  1⁄700 lb av . ≡ 0.45359237 kg / 700 ≡ 647.9891 mg.
 ...
 * @description <b>Slug; geepound; hyl</b> is  <i>mass</i> unit, symbol: [slug]. Definition of 1 slug; geepound; hyl ≡ 1 ɡ0 ×  lb av ×  s²/ft .  ≡ 9.80665 × 0.45359237 / 0.3048 ≡ 14.593903 kg.
 ...
 * @description <b>Stone</b> is  <i>mass</i> unit, symbol: [st]. Definition of 1 stone ≡ 14 lb av . ≡14 × 0.45359237 kg.
 ...
 * @description <b>Ton, long</b> is  <i>mass</i> unit, symbol: [ton; long tn]. Definition of 1 ton, long ≡ 2240 lb . 2240 × 0.45359237 kg.
 * @link http://conversion.org/mass/ton-long/
 */
export const TonLong = scale("Ton, long", "ton", mul(unit(1, PoundAvoirdupois), 2240));
export const TonLong__longTn = scale("Ton, long", "long tn", mul(unit(1, PoundAvoirdupois), 2240));

/** 
 * @summary 1 sh tn = 2000 lb
 * @description <b>Ton, short</b> is  <i>mass</i> unit, symbol: [sh tn]. Definition of 1 ton, short ≡ 2000 lb . 2000 × 0.45359237 kg.
...
/** 
 * @summary 1 t = 1000 kg
 * @description <b>Tonne</b> is metric <i>mass</i> unit, symbol: [t]. Definition of 1 tonne ≡ 1000 kg . ≡ 1 megagram (Mg) or 1 metric ton (tonne).
 ...
 * @description <b>Wey</b> is  <i>mass</i> unit. Definition of 1 wey ≡ 252 lb ≡ 18 st . 252 0.45359237 kg. Some other variants may exist.
 ...
 * @description <b>Bag (Portland cement)</b> is  <i>mass</i> unit. Definition of 1 bag (Portland cement) ≡ 94 lb av . ≡ 94 × 0.45359237 kg.
 ...
 * @description <b>Barge</b> is  <i>mass</i> unit. Definition of 1 barge ≡  22 1⁄2 short ton . ≡ 20411.65665 kg.
...
/** 
 * @summary 1 ct = 200 mg
 * @description <b>Carat (metric)</b> is  <i>mass</i> unit, symbol: [ct]. Definition of 1 carat (metric) ≡ 200 mg . The carat (ct) is a unit of mass equal to 200 mg and is used for measuring gemstones and pearls (metric carat).
 ...
 * @description <b>Clove</b> is  <i>mass</i> unit. Definition of 1 clove ≡ 8 lb av . ≡ 8 × 0.45359237 kg.
 ...
 * @description <b>Crith</b> is  <i>mass</i> unit. Definition of 1 crith ≡ 89.9349 mg. .
...
/** 
 * @summary 1 γ = 1 μg
 * @description <b>Gamma</b> is  <i>mass</i> unit, symbol: [γ]. Definition of 1 gamma ≡ 1 μg . ≡ 1 μg.
 ...
 * @description <b>Grain</b> is  <i>mass</i> unit, symbol: [gr]. Definition of 1 grain ≡  1⁄7000 lb av . The grain is the same in avoirdupois, troy, and apothecaries units of mass, ≡ 64.79891 mg.
 ...
 * @description <b>Hundredweight (short); cental</b> is  <i>mass</i> unit, symbol: [sh cwt]. Definition of 1 hundredweight (short); cental ≡ 100 lb av . ≡100 × 0.45359237 kg ≡ 45.359237 kg.
 ...
 * @description <b>Kip</b> is  <i>mass</i> unit, symbol: [kip]. Definition of 1 kip ≡ 1000 lb av . A kip is a unit of force, uncommon, it is occasionally also considered a unit of weight, equal to 1000 pounds. ≡1000 × 0.45359237 kg.
 ...
 * @description <b>Mite</b> is  <i>mass</i> unit. Definition of 1 mite ≡  1⁄20 gr . ≡ 1 grain / 20 ≡ 3.2399455 mg.
 ...
 * @description <b>Ounce (avoirdupois)</b> is  <i>mass</i> unit, symbol: [oz av]. Definition of 1 ounce (avoirdupois) ≡  1⁄16 lb . ≡ 0.45359237 kg /16 ≡ 28.349523125 g.
 ...
 * @description <b>Point</b> is  <i>mass</i> unit. Definition of 1 point ≡  1⁄100 ct . ≡ 2 mg.
 ...
 * @description <b>Pound (troy)</b> is  <i>mass</i> unit, symbol: [lb t]. Definition of 1 pound (troy) ≡ 5760 grains . 64.79891 g × 5760 ≡ 0.3732417216 kg.
 ...
 * @description <b>Quarter (informal)</b> is  <i>mass</i> unit. Definition of 1 quarter (informal) ≡  1⁄4 short ton . ≡ 907.18474 kg / 4.
 ...
 * @description <b>Quarter, long (informal)</b> is  <i>mass</i> unit. Definition of 1 quarter, long (informal) ≡  1⁄4 long ton . ≡ 1016.0469088 kg / 4.
 ...
 * @description <b>Scruple (apothecary)</b> is  <i>mass</i> unit, symbol: [s ap]. Definition of 1 scruple (apothecary) ≡ 20 gr . 20 × 0.06479891 g ≡ 1.2959782 g.
 ...
 * @description <b>Carat</b> is  <i>mass</i> unit, symbol: [kt]. Definition of 1 carat ≡  3 1⁄6 gr . ≡ 19/6 grain ≡ 205.1965483 mg.
 ...
 * @description <b>Dram (apothecary; troy)</b> is  <i>mass</i> unit, symbol: [dr t]. Definition of 1 dram (apothecary; troy) ≡ 60 gr . The dram (alternative British spelling drachm) was originally both a coin and a weight in ancient Greece. ≡ 60 grain ≡ 3.8879346 g.
 ...
 * @description <b>Ounce (apothecary; troy)</b> is  <i>mass</i> unit, symbol: [oz t]. Definition of 1 ounce (apothecary; troy) ≡  1⁄12 lb t . ≡ 31.1034768 g.
 ...
 * @description <b>Pennyweight</b> is  <i>mass</i> unit, symbol: [dwt; pwt]. Definition of 1 pennyweight ≡  1⁄20 oz t . ≡ 1.55517384 g.
 ...
 * @description <b>Ton, assay (long)</b> is  <i>mass</i> unit, symbol: [AT; ln AT]. Definition of 1 ton, assay (long) ≡ 1 mg ×  long ton /  oz t .  ≡ 32.(6) g.
...
export const TonAssayLong__ln_AT = scale("Ton, assay (long)", "ln AT", mul(unit(1, Milligram), unit(1, TonLong), pow(unit(1, OunceApothecaryTroy), -1), 1));

/** 
 * @summary 1 sh AT = 1 mg ×  short ton /  oz t
 * @description <b>Ton, assay (short)</b> is  <i>mass</i> unit, symbol: [sh AT]. Definition of 1 ton, assay (short) ≡ 1 mg ×  short ton /  oz t .  ≡ 29.1(6) g.
 ...
 * @description <b>Mark</b> is  <i>mass</i> unit. Definition of 1 mark ≡ 8 oz t . The Mark is originally a medieval weight or mass unit, which supplanted the pound weight as a precious metals and coinage weight from the 11th century ≡ 248.8278144 g.
